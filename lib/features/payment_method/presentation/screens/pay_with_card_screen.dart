...
class PaymentWithCardScreen extends StatefulWidget {
  const PaymentWithCardScreen({super.key});

  @override
  State<PaymentWithCardScreen> createState() => _PaymentWithCardScreenState();
}

class _PaymentWithCardScreenState extends State<PaymentWithCardScreen> {
