...
class WithdrawalSuccessOrFailureScreen extends StatefulWidget {
  const WithdrawalSuccessOrFailureScreen({super.key});

  @override
  State<WithdrawalSuccessOrFailureScreen> createState() =>
      _WithdrawalSuccessOrFailureScreenState();
}

class _WithdrawalSuccessOrFailureScreenState
    extends State<WithdrawalSuccessOrFailureScreen> {
