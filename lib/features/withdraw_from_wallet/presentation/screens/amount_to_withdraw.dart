...
class AmountToWithdrawScreen extends StatefulWidget {
  const AmountToWithdrawScreen({super.key});

  @override
  State<AmountToWithdrawScreen> createState() => _AmountToWithdrawScreenState();
}

class _AmountToWithdrawScreenState extends State<AmountToWithdrawScreen> {
        ...
        child: Column(
          ...
          children: [
            ...
            PrimaryButton(
              label: 'Withdraw',
              onPressed: () {
                Navigator.pushNamed(context, Routes.withdrawalSuccessOrFailure);
              },
              isEnabled: true,
            ),
          ],
